...
/*************************************************************
 * NOTE: This is a Sun Java file from Java version 1.5. We are 
 * incorporating it here until Cyc switches over to Java 1.5.
 * The only change to this file is changing the package and 
 * implementing an old Comparable interface, vs the new
 * 1.5 version which the original code did. This class should be
